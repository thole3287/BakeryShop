...
<div class="container">
    <div id="content">
            ...
            <div class="history-slider">
                ...
                <div class="history-slides">
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="Resources/FrontEnd/assets/dest/images/history.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
                                <h5 class="other-title">Lê Trường Thọ (Founder)</h5>
                                <p>
                                    Tân Hòa, Đức Lập Hạ, Đức Hòa, Long An<br />
                                    Việt Nam
                                </p>
                                <div class="space20">&nbsp;</div>
                                <p>- Xin chào, Mình tên là Lê Trường Thọ Mình đến từ Long An, năm nay mình 20 tuổi. Mình tham gia Lập Trình Web vì chính niềm đam mê về lĩnh vực CNTT khiến mình bị cuốn hút. Kể từ khi biết về Lập trình web mình đã rất mong được mọi người giúp đỡ. Hôm nay, mình đến đây để thực hiện giấc mơ này. Rất mong được sự giúp đỡ của các bạn.</p>
                            </div>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="space20">&nbsp;</div>
                                <p>Như đã nói ở trên photoshop là phần mềm được phát triển với chức năng chính để chỉnh sửa hình ảnh. Trong lĩnh vực thiết kế Ps là phần mềm bắt buộc phải biết của các designer. Không chỉ được sử dụng để chỉnh sửa ảnh; photoshop được sử dụng rất nhiều trong thiết kế hiển thị. Hiện nay Ps được xem là phần mềm đồ họa bitmap mạnh nhất trên thị trường. Photoshop cũng được đưa vào giáo trình giảng dạy chính thức của các trường đào tạo nghề cũng như các trường cao đẳng, đại học.</p>
                            </div>
                        </div>
                    </div>
                    <div>
        ...
        <div class="space20">&nbsp;</div>
        <p class="text-center wow fadeInLeft">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
            aliquip ex ea commodo consequat.<br /> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <div class="beta-person media">
                    ...
                    <img class="pull-left" src="Resources/FrontEnd/assets/dest/images/person2.jpg" alt="">

                    <div class="media-body beta-person-body">
                        <h5>Bob Robertson</h5>
                        <p class="font-large">Founder</p>
                        <p>Nemo enim ipsam voluptatem quia voluptas sit asatur aut odit aut fugit, sed quia consequuntur
                            magni dolores eos qui ratione voluptatem sequi nesciunt. Neque por quisquam est, qui dolorem
            ...
            <div class="col-sm-6 wow fadeInRight">
                <div class="beta-person media ">
                    ...
                    <img class="pull-left" src="Resources/FrontEnd/assets/dest/images/person3.jpg" alt="">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="Resources/FrontEnd/assets/dest/images/person1.jpg" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>Mark Priston</h5>
                        <p class="font-large">Web developer</p>
                        <p>Nemo enims voluptatem quia volupas sit aspe aut odit aut fugit, sed quia consequuntur magni
                            dolores.</p>
                        <a href="single_type_gallery.html">View projects <i class="fa fa-chevron-right"></i></a>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="Resources/FrontEnd/assets/dest/images/person2.jpg" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>Bob Robertson</h5>
                        <p class="font-large">Web developer</p>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="Resources/FrontEnd/assets/dest/images/person3.jpg" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>Mike Greenwood</h5>
                        <p class="font-large">Web developer</p>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="Resources/FrontEnd/assets/dest/images/person4.jpg" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>David Black</h5>
                        <p class="font-large">Web developer</p>
